    ...
    try {
      ...
      if (res.data.status === true && res.data.data?.access_token) {
        ...
        if (Array.isArray(res.data.message)) {
          ...
          addToast(res.data.message, { toastClass: 'bg-danger', delay: 3000 });
        }
      }
    } catch (error) {
    ...
    <div className="auth-box overflow-hidden align-items-center d-flex" style={{ minHeight: '100vh' }}>
      ...
      <Container>
        <Row className="justify-content-center">
          <Col xxl={4} md={6} sm={8}>
            <Card className="p-4">
              <div className="position-absolute top-0 end-0" style={{ width: 180, zIndex: 1 }}>
                <svg
              ...
              <Form style={{ zIndex: 5 }} onSubmit={handleSubmit(onSubmit)}>
            ...
            <p className="text-center text-muted mt-4 mb-0">© {currentYear} Sun Rise</p>
          </Col>
        </Row>
      </Container>
    </div>
